...
using IntranuclearCascade::Particle;
using IntranuclearCascade::FourVector;
using IntranuclearCascade::ThreeVector;

void ParticleModule(py::module &m) {
    py::enum_<IntranuclearCascade::ParticleStatus>(m, "ParticleStatus", py::module_local())
        .value("internal_test", IntranuclearCascade::ParticleStatus::internal_test)
        .value("external_test", IntranuclearCascade::ParticleStatus::external_test)
        .value("propagating", IntranuclearCascade::ParticleStatus::propagating)
        .value("background", IntranuclearCascade::ParticleStatus::background)
        .value("escaped", IntranuclearCascade::ParticleStatus::escaped);
