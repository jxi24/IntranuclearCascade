#include "IntranuclearCascade/ParticleInfo.hh"
...
using IntranuclearCascade::PID;
using IntranuclearCascade::ParticleInfoEntry;
using IntranuclearCascade::ParticleInfo;

// IntranuclearCascade::Database::ParticleDB IntranuclearCascade::Database::particleDB{};
...
struct convert<ParticleInfoEntry> {
    ...
    static bool decode(const Node &node, ParticleInfoEntry &partInfo) {
        ...
        partInfo.id = static_cast<IntranuclearCascade::PID>(node[0].as<int>());
...
void IntranuclearCascade::ParticleInfo::BuildDatabase(const std::string &datafile) {
...
void IntranuclearCascade::ParticleInfo::PrintDatabase() {
...
ParticleInfoEntry::ParticleInfoEntry(const IntranuclearCascade::PID &id_, const double &mass_,
