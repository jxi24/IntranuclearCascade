...
const std::array<double, 3> IntranuclearCascade::ToCartesian(const std::array<double, 3>& vec) {
...
bool IntranuclearCascade::sortPairSecond(const std::pair<std::size_t, double>& a,
...
double IntranuclearCascade::Brent::CalcRoot(double a, double b) const {
